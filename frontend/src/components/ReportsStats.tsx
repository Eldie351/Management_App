...
export default function ReportsStats() {
  ...
  useEffect(() => {
    ...
    async function load() {
      setKpisLoading(true);
      try {
        const res = await axios.get<KPIResponse>(`${API}/api/reports/kpis`, {
  ...
  useEffect(() => {
    ...
    async function load() {
      ...
      try {
        const res = await axios.get<SalesPoint[]>(`${API}/api/reports/sales/series`, {
  ...
  useEffect(() => {
    ...
    async function load() {
      ...
      try {
        const res = await axios.get<StorePerf[]>(`${API}/api/reports/stores`, {
          params: { start: startISO, end: endISO },
        });
  ...
  useEffect(() => {
    ...
    async function load() {
      setDayLoading(true);
      try {
        const res = await axios.get<SaleDetail[]>(`${API}/api/reports/sales/day`, { params: { date: selectedDay } });
